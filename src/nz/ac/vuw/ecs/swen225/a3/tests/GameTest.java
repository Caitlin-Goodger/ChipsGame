...
//	@Test
//	public void test06() {
//		Tile wall = new Wall(5, 5);
//		wall.updatePosition('N');
//		assertEquals(6, wall.getYPosition());
//	}
//
//	/**
//	 * Testing update position method in wall tile.
...
//		assertEquals(4, wall.getYPosition());
//	}
//
//	/**
//	 * Testing update position method in wall tile.
...
//		assertEquals(6, wall.getXPosition());
//	}
//
//	/**
//	 * Testing update position method in wall tile.
...
//		assertEquals(4, wall.getXPosition());
//	}
//
//	/**
...
//	@Test
//	public void test10() {
//		Tile exit = new Exit(5, 5);
//		exit.updatePosition('N');
//		assertEquals(6, exit.getYPosition());
//	}
//
//	/**
//	 * Testing update position method in exit tile.
...
//		assertEquals(4, exit.getYPosition());
//	}
//
//	/**
//	 * Testing update position method in exit tile.
...
//		assertEquals(6, exit.getXPosition());
//	}
//
//	/**
//	 * Testing update position method in exit tile.
...
//		assertEquals(4, exit.getXPosition());
//	}
//
//	/**
...
//	@Test
//	public void test14() {
//		Tile exitLock = new ExitLock(5, 5);
//		exitLock.updatePosition('N');
//		assertEquals(6, exitLock.getYPosition());
//	}
//
//	/**
//	 * Testing update position method in exit lock tile.
...
//		assertEquals(4, exitLock.getYPosition());
//	}
//
//	/**
//	 * Testing update position method in exit lock tile.
...
//		assertEquals(6, exitLock.getXPosition());
//	}
//
//	/**
//	 * Testing update position method in exit lock tile.
...
//		assertEquals(4, exitLock.getXPosition());
//	}
//
//	/**
...
//	@Test
//	public void test18() {
//		Tile free = new Free(5, 5);
//		free.updatePosition('N');
//		assertEquals(6, free.getYPosition());
//	}
//
//	/**
//	 * Testing update position method in free tile.
...
//		assertEquals(4, free.getYPosition());
//	}
//
//	/**
//	 * Testing update position method in free tile.
...
//		assertEquals(6, free.getXPosition());
//	}
//
//	/**
//	 * Testing update position method in free tile.
...
//		assertEquals(4, free.getXPosition());
//	}
//
//	/**
...
//	@Test
//	public void test22() {
//		Tile infoField = new InfoField("Hey", 5, 5);
//		infoField.updatePosition('N');
//		assertEquals(6, infoField.getYPosition());
//	}
//
//	/**
//	 * Testing update position method in infofield tile.
...
//		assertEquals(4, infoField.getYPosition());
//	}
//
//	/**
//	 * Testing update position method in infofield tile.
...
//		assertEquals(6, infoField.getXPosition());
//	}
//
//	/**
//	 * Testing update position method in infofield tile.
...
//		assertEquals(4, infoField.getXPosition());
//	}
//
//	/**
...
//	@Test
//	public void test26() {
//		Tile key = new Key("Hey", 5, 5);
//		key.updatePosition('N');
//		assertEquals(6, key.getYPosition());
//	}
//
//	/**
//	 * Testing update position method in key tile.
...
//		assertEquals(4, key.getYPosition());
//	}
//
//	/**
//	 * Testing update position method in key tile.
...
//		assertEquals(6, key.getXPosition());
//	}
//
//	/**
//	 * Testing update position method in key tile.
...
//		assertEquals(4, key.getXPosition());
//	}
//
//	/**
...
//	@Test
//	public void test30() {
//		Tile lockedDoor = new LockedDoor("Hey", 5, 5);
//		lockedDoor.updatePosition('N');
//		assertEquals(6, lockedDoor.getYPosition());
//	}
//
//	/**
//	 * Testing update position method in locked door tile.
...
//		assertEquals(4, lockedDoor.getYPosition());
//	}
//
//	/**
//	 * Testing update position method in locked door tile.
...
//		assertEquals(6, lockedDoor.getXPosition());
//	}
//
//	/**
//	 * Testing update position method in locked door tile.
...
//		assertEquals(4, lockedDoor.getXPosition());
//	}
//
//	/**
...
//	@Test
//	public void test34() {
//		Tile treasure = new Treasure(5, 5);
//		treasure.updatePosition('N');
//		assertEquals(6, treasure.getYPosition());
//	}
//
//	/**
//	 * Testing update position method in treasure tile.
...
//		assertEquals(4, treasure.getYPosition());
//	}
//
//	/**
//	 * Testing update position method in treasure tile.
...
//		assertEquals(6, treasure.getXPosition());
//	}
//
//	/**
//	 * Testing update position method in treasure tile.
...
//		assertEquals(4, treasure.getXPosition());
//	}
//
//	/**
//	 * Testing update position method in wall tile.
...
//	}
	...
	/**
	 * Testing the get Y position on the screen in the chap
	 * class.
	 */
	@Test
	public void test151() {
	...
	/**
	 * Testing the get x position on the screen in the chap
	 * class.
	 */
	@Test
	public void test152() {
...
//
//	/**
//	 * Testing get amount of remaining treasure method in Maze
//	 * class.
//	 */
//	@Test
//	public void test189() {
